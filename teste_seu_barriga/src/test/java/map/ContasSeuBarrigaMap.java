...
public class ContasSeuBarrigaMap {
	...
	protected WebElement btnListarContas;
	@FindBy(xpath = "//table[@id='tabelaContas']")
	protected WebElement tabelaContas;
	@FindBy(xpath = "(//div)[4]")
	protected WebElement iconContaJaAdd;
	@FindBy(xpath = "(//table[@id='tabelaContas']/descendant::a)[2]")
	protected WebElement excluirConta;
	@FindBy(xpath = "(//table[@id='tabelaContas']/descendant::a)[3]")
	protected WebElement editarContas;
}
